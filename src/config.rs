    ...
    pub fn from_env() -> Self {
        ...
        dex_protocols.insert(
            ...
            DexProtocol {
                ...
                pools: vec![
                    "B4e16d0168e52d35CaCD2c6185b44281Ec28C9Dc".to_string(), // USDC/ETH
                    "0d4a11d5EEaaC28EC3F61d100daF4d40471f1852".to_string(), // ETH/USDT
                ],
            },
        );
        dex_protocols.insert(
            ...
            DexProtocol {
                ...
                pools: vec![
                    "8ad599c3A0ff1De082011EFDDc58f1908eb6e6D8".to_string(), // USDC/ETH 0.3%
                    "7BeA39867e4169DBe237d55C8242a8f2fcDcc387".to_string(), // ETH/USDT 0.3%
                ],
            },
        );
        dex_protocols.insert(
            ...
            DexProtocol {
                ...
                pools: vec![
                    "397FF1542f962076d0BFE58eA045FfA2d347ACa0".to_string(), // ETH/USDC
                    "06da0fd433C1A5d7a4faa01111c044910A184553".to_string(), // ETH/USDT
                ],
            },
        );
        Self {
